...
| `notification-api` | Synchronizes ScyllaDB data into Elasticsearch and sends notifications |
...
## Trigger ScyllaDB → Elasticsearch Sync
...
The Notification API owns the ScyllaDB → Elasticsearch synchronization. Trigger it with `POST /api/v1/notification/sync`.
